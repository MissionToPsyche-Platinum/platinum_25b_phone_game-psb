        ...
        IEnumerator AnimateVertexColors()
        {
            ...
            while (true)
            {
                ...
                for (int i = 0; i < textInfo.meshInfo.Length; i++)
                {
                    ...
                    // Updated 11/19/25 - Convert Vector4[] to Vector2[]
                    Vector2[] convertedUVs = new Vector2[textInfo.meshInfo[i].uvs0.Length];
                    for (int j = 0; j < textInfo.meshInfo[i].uvs0.Length; j++)
                    {
                        convertedUVs[j] = new Vector2(textInfo.meshInfo[i].uvs0[j].x, textInfo.meshInfo[i].uvs0[j].y);
                    }
